...
if (!configEl) {
    ...
    // Only set up basic play button functionality (clipboard handled by clipboard_utils.js)
...
// AIDEV-NOTE: Clipboard copy functions moved to clipboard_utils.js (issue #228)
