...
class ContentAnalysisService:
    ...
    def _create_analysis_prompt(self, text, title):
        ...
        2. The overall tone of the article (formal, casual, technical, storytelling)
        3. A recommendation for voice parameters suitable for narrating this content

        Return your analysis in the following JSON format:
        {{
            "summary": "2-3 sentence summary here",
            "tone": "detected tone (formal, casual, technical, storytelling, narrative,
                       news, conversational)",
            "voice_recommendation": {{
                "voice": "recommended voice (alloy, echo, fable, onyx, nova, shimmer)",
