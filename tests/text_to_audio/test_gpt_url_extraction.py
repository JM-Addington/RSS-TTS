...
class GptUrlExtractionTests(TestCase):
    ...
    def test_extract_article_text_with_gpt_success(self, mock_openai_class):
        ...
        success, text, error = extract_article_text_with_gpt(html, "https://example.com")
    ...
    def test_process_url_to_text_uses_gpt_when_enabled(self, mock_traditional, mock_gpt, mock_fetch):
    ...
    @patch('text_to_audio.utils.extract_article_text')
    @override_settings(USE_GPT_FOR_URL_EXTRACTION=True)
    def test_process_url_to_text_falls_back_on_gpt_failure(self, mock_traditional, mock_gpt, mock_fetch):
    ...
    def test_process_url_to_text_skips_gpt_when_disabled(self, mock_traditional, mock_gpt, mock_fetch):
