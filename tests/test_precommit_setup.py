...
class TestPrecommitSetup(unittest.TestCase):
    ...
    SCRIPT_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "setup_precommit.sh")

    def test_script_exists(self):
        """Ensure the script file exists."""
        self.assertTrue(os.path.isfile(self.SCRIPT_PATH), "setup_precommit.sh should exist")
    ...
    def test_script_executable(self):
        ...
        self.assertTrue(st.st_mode & stat.S_IEXEC, "setup_precommit.sh should be executable")
