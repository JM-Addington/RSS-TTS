...
| **Technology Stack** | Django 5 + DRF • Celery 6 + Redis • PostgreSQL • OpenAI TTS (`tts-1` / `gpt-4o-mini-tts`) • OpenAI o3-mini & GPT-4.1 for tone/extraction • Docker Compose dev/prod • Bootstrap 5 for UI.                                                                 |
